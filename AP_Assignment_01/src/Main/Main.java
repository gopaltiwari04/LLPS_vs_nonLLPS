...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        allCourses.add(new Course("CS102", "DC", "Dr. Brown", 3, new ArrayList<>(), 1,"10:00AM-11:30AM", "LHC 101",studentList));
        allCourses.add(new Course("CS103", "LA", "Dr. White", 3, new ArrayList<>(), 1,"12:00PM-1:00PM", "LHC 201",studentList));
        allCourses.add(new Course("CS104", "HCI", "Dr. Green", 3, new ArrayList<>(), 1,"2:00PM-3:00PM","RND B003",studentList));
        ...
        allCourses.add(new Course("CS201", "DSA", "Dr. Black", 4, new ArrayList<>(), 2,"9:00AM-10:00AM", "LHC 101",studentList));
        allCourses.add(new Course("CS202", "BE", "Dr. Gray", 3, new ArrayList<>(), 2,"10:00AM-11:30AM", "LHC 101",studentList));
        allCourses.add(new Course("CS203", "CO", "Dr. Violet", 3, new ArrayList<>(), 2,"12:00PM-1:00PM", "LHC 201",studentList));
        allCourses.add(new Course("CS204", "PNS", "Dr. Yellow", 3, new ArrayList<>(), 2,"2:00PM-3:00PM","RND B003",studentList));
        allCourses.add(new Course("CS205", "CTRSS", "Dr. Orange", 2, new ArrayList<>(), 2,"4:00PM-5:00PM","Old Acad C01",studentList));

        // Courses for Semester 3
        allCourses.add(new Course("CS301", "RA", "Dr. Regulus", 4, new ArrayList<>(), 3,"9:00AM-10:00AM", "LHC 101", studentList));
        allCourses.add(new Course("CS302", "DS", "Dr. Maximus", 4, new ArrayList<>(), 3,"10:00AM-11:30AM", "LHC 101", studentList));
        allCourses.add(new Course("CS303", "AP", "Dr. Capsicum", 3, new ArrayList<>(), 3,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS304", "OS", "Dr. Tyrone", 3, new ArrayList<>(), 3,"2:00PM-3:00PM","RND B003", studentList));
        ...
        allCourses.add(new Course("CS402", "Computer Networks", "Dr. Maximus", 4, new ArrayList<>(), 4,"10:00AM-11:30AM", "LHC 101", studentList));
        allCourses.add(new Course("CS403", "Software Engineering", "Dr. Dre", 3, new ArrayList<>(), 4,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS404", "Discrete Mathematics", "Dr. Lamar", 3, new ArrayList<>(), 4,"2:00PM-3:00PM","RND B003", studentList));
        ...
        allCourses.add(new Course("CS503", "Computer Architecture", "Dr. Cole", 3, new ArrayList<>(), 5,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS504", "Object-Oriented Programming", "Dr. Kanye", 3, new ArrayList<>(), 5,"2:00PM-3:00PM","RND B003", studentList));
        allCourses.add(new Course("CS505", "Web Development", "Dr. Carti", 2, new ArrayList<>(), 5,"4:00PM-5:00PM","Old Acad C01", studentList));

        // Courses for Semester 6
        allCourses.add(new Course("CS601", "Statistical Machine Learning", "Dr. Wayne", 4, new ArrayList<>(), 6,"9:00AM-10:00AM", "LHC 101", studentList));
        ...
        allCourses.add(new Course("CS603", "Artificial Intelligence", "Dr. Tecca", 3, new ArrayList<>(), 6,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS604", "Mobile Application Development", "Dr. Tay", 3, new ArrayList<>(), 6,"2:00PM-3:00PM","RND B003", studentList));
        allCourses.add(new Course("CS605", "Embedded Systems", "Dr. Keith", 2, new ArrayList<>(), 6,"4:00PM-5:00PM","Old Acad C01", studentList));
        ...
        allCourses.add(new Course("CS703", "Big Data", "Dr. Smoke", 3, new ArrayList<>(), 7,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS704", "Natural Language Processing", "Dr. Cube", 3, new ArrayList<>(), 7,"2:00PM-3:00PM","RND B003", studentList));
        ...
        allCourses.add(new Course("CS803", "Software Testing and Quality Assurance", "Dr. Slim", 3, new ArrayList<>(), 8,"12:00PM-1:00PM", "LHC 201", studentList));
        allCourses.add(new Course("CS804", "Computer Vision", "Dr. Shady", 3, new ArrayList<>(), 8,"2:00PM-3:00PM","RND B003", studentList));
        allCourses.add(new Course("CS805", "Robotics", "Dr. Dre", 2, new ArrayList<>(), 8,"4:00PM-5:00PM","Old Acad C01", studentList));
    ...
    private static Administrator administratorLogin(Scanner sc) {
        ...
        if (email.equals("admin@university.edu") && password.equals("adminpass")) {
            ...
            return new Administrator("Admin", email, password);  // Create Administrator object
        } else {
            System.out.println("Login failed. Invalid email or password.");
            return null;
        }
